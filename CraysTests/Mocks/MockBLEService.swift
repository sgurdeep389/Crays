...
class MockBLEService: NSObject {
    ...
    var sentMessages: [(message: CraysMessage, packet: CraysPacket)] = []
    var sentPackets: [CraysPacket] = []
    var connectedPeers: Set<String> = []
    var messageDeliveryHandler: ((CraysMessage) -> Void)?
    var packetDeliveryHandler: ((CraysPacket) -> Void)?
    ...
    func simulateIncomingMessage(_ message: CraysMessage) {
    ...
    func simulateIncomingPacket(_ packet: CraysPacket) {
