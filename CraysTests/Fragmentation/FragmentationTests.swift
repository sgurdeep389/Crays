...
final class FragmentationTests: XCTestCase {
    ...
    private final class CaptureDelegate: CraysDelegate {
    ...
    private func makeLargePublicPacket(senderShortHex: String, size: Int) -> CraysPacket {
    ...
    private func fragmentPacket(_ packet: CraysPacket, fragmentSize: Int, fragmentID: Data? = nil) -> [CraysPacket] {
