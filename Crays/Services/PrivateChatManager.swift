...
class PrivateChatManager: ObservableObject {
    @Published var privateChats: [String: [CraysMessage]] = [:]
    ...
    func handleIncomingMessage(_ message: CraysMessage) {
    ...
    func getCurrentMessages() -> [CraysMessage] {
    ...
    private func sendReadReceipt(for message: CraysMessage) {
