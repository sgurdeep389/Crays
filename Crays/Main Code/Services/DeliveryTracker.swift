...
class DeliveryTracker {
    ...
    func trackMessage(_ message: CraysMessage, recipientID: String, recipientNickname: String, isFavorite: Bool = false, expectedRecipients: Int = 1) {
    ...
    func generateAck(for message: CraysMessage, myPeerID: String, myNickname: String, hopCount: UInt8) -> DeliveryAck? {
