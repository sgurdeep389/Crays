...
struct PeerDisplayData: Identifiable {
    ...
    let connectionState: CraysPeer.ConnectionState
...
struct ContentView: View {
    ...
    private var textColor: Color {
        self.colorScheme == .dark ? Color.black : Color.black
    }
    ...
    var body: some View {
        ...
        for segment in segments {
            if segment.type == "hashtag" {
                ...
                result = result + Text(segment.text)
                    .font(.custom(self.isMentioned ? "Poppins-Bold" : "Poppins-Regular", size: 14))
            }
        }
