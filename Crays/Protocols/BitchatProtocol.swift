...
/// # CraysProtocol
///
/// Defines the application-layer protocol for Crays mesh networking, including
/// message types, packet structures, and encoding/decoding logic.
///
/// ## Overview
/// CraysProtocol implements a binary protocol optimized for Bluetooth LE's
...
/// Simplified Crays protocol message types.
...
/// The core packet structure for all Crays protocol messages.
/// Encapsulates all data needed for routing through the mesh network,
/// including TTL for hop limiting and optional encryption.
/// - Note: Packets larger than BLE MTU (512 bytes) are automatically fragmented
struct CraysPacket: Codable {
    let version: UInt8
    let type: UInt8
    let senderID: Data
    ...
    func toBinaryDataForSigning() -> Data? {
        ...
        let unsignedPacket = CraysPacket(
            type: type,
            senderID: senderID,
    ...
    static func from(_ data: Data) -> CraysPacket? {
...
/// Represents a user-visible message in the Crays system.
/// Handles both broadcast messages and private encrypted messages,
/// with support for mentions, replies, and delivery tracking.
/// - Note: This is the primary data model for chat messages
class CraysMessage: Codable {
    let id: String
    let sender: String
    let content: String
    let timestamp: Date
...
// Equatable conformance for CraysMessage
extension CraysMessage: Equatable {
    static func == (lhs: CraysMessage, rhs: CraysMessage) -> Bool {
...
protocol CraysDelegate: AnyObject {
