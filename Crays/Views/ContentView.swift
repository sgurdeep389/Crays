...
struct ContentView: View {
    ...
    private var secondaryTextColor: Color {
        colorScheme == .dark ? Color.white.opacity(0.8) : .black.opacity(0.8)
    }
    ...
    private func messagesView(privatePeer: String?, isAtBottom: Binding<Bool>) -> some View {
        ScrollViewReader { proxy in
            ...
            .background(backgroundColor)
            .onOpenURL { url in
                guard url.scheme == "Crays", url.host == "user" else { return }
            ...
            .onOpenURL { url in
                guard url.scheme == "Crays", url.host == "geohash" else { return }
    ...
    private func channelPeopleCountAndColor() -> (Int, Color) {
        ...
        case .location:
            ...
            let standardGreen = (colorScheme == .dark) ? Color.white : .black
