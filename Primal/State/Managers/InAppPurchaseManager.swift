...
final class InAppPurchaseManager: NSObject {
    ...
    static let monthlyPremiumId = "crays_monthly_plan"
    static let yearlyPremiumId = "crays_yearly_plan"
    static let monthlyProId = "crays_monthly_plan"
    static let yearlyProId = "crays_yearly_plan"
