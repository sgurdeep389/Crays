...
class PushNotificationCell: UITableViewCell, Themeable {
    ...
    let titleLabel: UILabel = UILabel("Enable push notifications from Crays", color: .foreground, font: .appFont(withSize: 16, weight: .regular))
    let descLabel: UILabel = UILabel("Get system notifications from Crays. You can also configure this in your system settings.", color: .foreground2, font: .appFont(withSize: 14, weight: .regular))
