...
private extension SettingsWalletViewController {
    ...
    func setup() {
        ...
        let primalWallet = SettingsSwitchView("Use Crays wallet")
        ...
        let maxBalanceDesc = descLabel("Crays is a transactional wallet, designed for handling small amounts. We recommend self custody for larger amounts.")
        ...
        let primalStack = UIStackView(axis: .vertical, [
            ...
            descLabel("Open the wallet when Crays starts"),                                                                    SpacerView(height: 24),
