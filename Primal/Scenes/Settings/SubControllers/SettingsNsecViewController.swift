...
private extension SettingsNsecViewController {
    ...
    func setupView() {
        ...
        dangerDesc.text = "This will permanently delete your Nostr account. You won’t be able to login via Crays or other Nostr apps."
        ...
        deleteButton.addAction(.init(handler: { [weak self] _ in
            let alert = UIAlertController(
                ...
                message: "HEY THIS IS SERIOUS!!\n\nIf you delete your account you will not be able to sign in using that account via Crays or any other Nostr client. Are you sure you want to do this?",
