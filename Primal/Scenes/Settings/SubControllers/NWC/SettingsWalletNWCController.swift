...
final class SettingsWalletNWCController: UIViewController {
    ...
    let descLabel = UILabel("You can connect your Crays Wallet to other Nostr apps via Nostr Wallet Connect to enable zapping and payments.", color: .foreground4, font: .appFont(withSize: 14, weight: .regular))
    ...
    func updateContentStack() {
        ...
        if nwcs.isEmpty {
            ...
            let label = UILabel("There are no apps connected to Crays Wallet", color: .foreground4, font: .appFont(withSize: 15, weight: .regular), multiline: true)
