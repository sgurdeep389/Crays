...
final class SettingsNotificationsViewController: UIViewController, Themeable {
    ...
    var didDenyNotifications = false {
        didSet {
            pushInfoLabel.text = didDenyNotifications ? "You need to enable notifications in your system settings." : "Get system notifications from Crays. You can also configure this in your system settings."
