...
/// # BinaryProtocol
///
/// Low-level binary encoding and decoding for Crays protocol messages.
...
/// Implements binary encoding and decoding for Crays protocol messages.
/// Provides static methods for converting between CraysPacket objects and
...
struct BinaryProtocol {
    ...
    // Encode CraysPacket to binary format
    static func encode(_ packet: CraysPacket, padding: Bool = true) -> Data? {
        var data = Data()
    ...
    // Decode binary data to CraysPacket
    static func decode(_ data: Data) -> CraysPacket? {
    ...
    private static func decodeCore(_ raw: Data) -> CraysPacket? {
...
// Binary encoding for CraysMessage
extension CraysMessage {
    ...
    static func fromBinaryPayload(_ data: Data) -> CraysMessage? {
