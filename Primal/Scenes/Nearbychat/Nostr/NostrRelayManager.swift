...
class NostrRelayManager: ObservableObject {
    ...
    private var messageHandlers: [String: (NostrEvent1) -> Void] = [:]
    private var cancellables = Set<AnyCancellable>()
    
    // Message queue for reliability
    private var messageQueue: [(event: NostrEvent1, relayUrls: [String])] = []
    ...
    func sendEvent(_ event: NostrEvent1, to relayUrls: [String]? = nil) {
    ...
    func subscribe(
        ...
        handler: @escaping (NostrEvent1) -> Void
    ) {
                ...
                case "EVENT":
                    if array.count >= 3,
                       ...
                       let eventDict = array[2] as? [String: Any] {
                        ...
                        let event = try NostrEvent1(from: eventDict)
    ...
    private func sendToRelay(event: NostrEvent1, connection: URLSessionWebSocketTask, relayUrl: String) {
