...
struct NostrProtocol {
    ...
    static func createPrivateMessage(
        ...
        let ephemeralKey = try secp256k1.Schnorr.PrivateKey()
    ...
    private static func createGiftWrap(
        seal: NostrEvent1,
        recipientPubkey: String,
        senderKey: secp256k1.Schnorr.PrivateKey  // This is the ephemeral key used for the seal
    ) throws -> NostrEvent1 {
        
        let sealJSON = try seal.jsonString()
        
        // Create new ephemeral key for gift wrap
        let wrapKey = try secp256k1.Schnorr.PrivateKey()
    ...
    private static func unwrapGiftWrap(
        ...
        let seal = try NostrEvent1(from: sealDict)
        // Unwrapped seal
    ...
    private static func openSeal(
        ...
        return try NostrEvent1(from: rumorDict)
    }
    ...
    private static func deriveSharedSecret(
        ...
        let keyAgreementPrivateKey = try secp256k1.KeyAgreement.PrivateKey(
        ...
        do {
            keyAgreementPublicKey = try secp256k1.KeyAgreement.PublicKey(
    ...
    private static func deriveSharedSecretDirect(
        ...
        let keyAgreementPublicKey = try secp256k1.KeyAgreement.PublicKey(
...
struct NostrEvent1: Codable {
    ...
    func sign(with key: secp256k1.Schnorr.PrivateKey) throws -> NostrEvent1 {
