...
// Crays
//
// Handles command parsing and execution for Crays
...
class CommandProcessor {
    ...
    @MainActor
    func process(_ command: String) -> CommandResult1 {
    ...
    private func handleMessage1(_ args: String) -> CommandResult1 {
    ...
    private func handleWho() -> CommandResult1 {
    ...
    private func handleClear() -> CommandResult1 {
    ...
    private func handleEmote(_ args: String, action: String, emoji: String, suffix: String = "") -> CommandResult1 {
    ...
    private func handleBlock(_ args: String) -> CommandResult1 {
        let targetName = args.trimmingCharacters(in: .whitespaces)
    ...
    private func handleUnblock(_ args: String) -> CommandResult1 {
        let targetName = args.trimmingCharacters(in: .whitespaces)
        guard !targetName.isEmpty else {
    ...
    private func handleFavorite(_ args: String, add: Bool) -> CommandResult1 {
        let targetName = args.trimmingCharacters(in: .whitespaces)
        guard !targetName.isEmpty else {
    ...
    private func handleHelp() -> CommandResult1 {
        let helpText = """
        commands:
