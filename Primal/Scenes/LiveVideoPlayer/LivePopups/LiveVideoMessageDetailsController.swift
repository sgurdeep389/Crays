...
class LiveVideoMessageDetailsController: UIViewController, LiveVideoUserDetailsViewControllerProtocol, Themeable {
    ...
    private lazy var nipLabel = UILabel((userForDetails.data.secondIdentifier ?? "").replacingOccurrences(of: "primal", with: "crays"), color: .foreground5, font: .appFont(withSize: 14, weight: .regular))
