                ...
                case .purchased:
                    ...
                    PrimalWalletRequest(type: .inAppPurchase(transactionId: transactionId, quote: quote.quote_id))
                        ...
                        .sink { result in
                            ...
                            if let message = result.message {
                                self?.present(WalletTransferSummaryController(.failure(navTitle: "Payment Failed", title: "Unable to send", message: "We were not able to send sats to your wallet. Please contact us at support@crays.net and we will assist you.")), animated: true)
                            } else {
