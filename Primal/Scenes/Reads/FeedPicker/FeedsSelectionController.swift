...
extension PrimalFeed {
    ...
    static let defaultReadsFeed = PrimalFeed(name: "All reads", spec: "{\"kind\":\"reads\",\"minwords\":\"0\"}")
...
private extension FeedsSelectionController {
    ...
    func showRestoreFeedsDialog() {
        let alert = UIAlertController(title: "This will replace your feed list with default  Crays feeds.", message: "Do you wish to continue?", preferredStyle: .alert)
...
class FeedSelectionCell: UITableViewCell {
    ...
    func setup(_ feed: PrimalFeed, selected: Bool, editing: Bool, delegate: FeedSelectionCellDelegate) {
        ...
        titleLabel.text = feed.name.replacingOccurrences(of: "Primal", with: "Crays")
        subtitleLabel.text = feed.description.replacingOccurrences(of: "Primal", with: "Crays")
