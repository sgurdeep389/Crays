...
private extension PremiumManageNameController {
    func setup() {
        ...
        let actionButton = LargeRoundedButton(title: "Change Crays Name Now")
    ...
    func userStackView() -> UIView? {
        ...
        userStack.addArrangedSubview(UILabel("Your Crays Name is available!", color: .init(rgb: 0x52CE0A), font: .appFont(withSize: 16, weight: .semibold)))
