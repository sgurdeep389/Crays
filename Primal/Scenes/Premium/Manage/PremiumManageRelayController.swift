...
class PremiumManageRelayController: UIViewController {
    override func viewDidLoad() {
        ...
        let longText = "The Crays Premium relay is a high-performance Nostr relay that only accepts content from Crays Premium users. Posting to this relay improves your visibility on the Nostr network because it guarantees high signal and lack of spam to any Nostr user that reads from it."
