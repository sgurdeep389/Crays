...
class PremiumManageController: UIViewController {    let state: PremiumState
    ...
    override func viewDidLoad() {
        ...
        var bottomOptions: [UIAction] = [
            ...
            .init(title: "Change your Crays name", handler: { [weak self] _ in
        ...
        let mainStack = UIStackView(axis: .vertical, [
            ...
            UILabel("Crays Account", color: .foreground, font: .appFont(withSize: 18, weight: .bold)), SpacerView(height: 16),
