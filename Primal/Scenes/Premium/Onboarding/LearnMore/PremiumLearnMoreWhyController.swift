...
class PremiumLearnMoreWhyController: UIViewController {
    override func viewDidLoad() {
        ...
        At Crays, we don’t rely on advertising. We don’t monetize user data. Our users are our customers. Our sole focus is to make the best possible product for our users. We open source all our work to help the Nostr ecosystem flourish. By signing up for Crays Premium, you are enabling us to continue building for Nostr.
...
class PremiumLearnMoreProController: UIViewController {
    override func viewDidLoad() {
        ...
        let descLabel = UILabel()
        descLabel.attributedText = .init(string: """
        Crays Pro is the highest user tier at Crays, designed for content creators and teams. Pro users get access to Crays Studio and gain Legend status on Crays: 
        """, attributes: [
            .font: UIFont.appFont(withSize: 16, weight: .regular),
            .foregroundColor: UIColor.foreground3,
            .paragraphStyle: paragraph
        ...
        A professional publishing suite for Nostr. Includes authoring tools, media management, smart scheduling, content imports, team collaboration, and content analytics.
        """, attributes: [
...
//        }))
        let firstVStack = UIStackView(axis: .vertical, [
            UILabel("Crays Studio", color: .foreground, font: .appFont(withSize: 16, weight: .semibold)),
            firstDescLabel,
//            studioButton
        ])
...
//        studioButton.transform = .init(translationX: -12, y: 0)
        ...
        Customizable Legend avatar ring, Legend profile badge and banner, along with the highest level of features, visibility and recognition on Crays.
        """, attributes: [
            .font: UIFont.appFont(withSize: 15, weight: .regular),
            .foregroundColor: UIColor.foreground3,
            .paragraphStyle: paragraph
