...
private extension OnboardingSigninController {
    ...
    func signIn(_ nsec: String) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + .seconds(3)) {
            RootViewController.instance.showErrorMessage(title: "Logged in with npub", "Crays is in read only mode because you are signed in via your public key. To enable all options, please sign in with your private key, starting with 'nsec...")
        }
    }
